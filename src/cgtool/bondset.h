...
/**
 * \brief Class that holds all bond lengths, angles and dihedrals to be
 * calculated
 */
class BondSet
{
...
public:
    /** Vector of bond length pairs; Contains all bond lengths that must be
     * calculated */
     ...
     *
     * Gets Vectors of all bond lengths, angles and dihedrals that must be
     * calculated.
     */
     ...
     * There are stored inside the BondStructs to be passed to averaging
     * functions later.
     */
